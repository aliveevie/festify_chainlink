...
import "../contracts/festify-cross-chain/FestifySenderOnCChain.sol";

contract DeployFestifySender is Script {
    function run() external {
        ...
        FestifySenderOnCChain sender = new FestifySenderOnCChain();
        console.log("FestifySenderOnCChain deployed at:", address(sender));
